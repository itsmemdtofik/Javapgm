...
class student{
	...
	student(String sName, String lsName, long regno, String dept, char gender, String addrs, char section, String email, long mbno, int mm, int dd, int yy ){
	...
	public void studentDisplay(){
		...
		System.out.println("Date of joining is : " + this.Calendar.get(Calendar.DATE) + "/"+this.Calendar.get(Calendar.MONTH)+"/"+this.Calendar.get(Calendar.YEAR));
		System.out.println();
		System.out.println("------------------------------------------------------");
...
class ArrayOfStudent {
	public static void main(String[] args) {
		...
		for(var i = 0; i < stuArr.length; i++){
		    ...
		    stuArr[i] = new student(studentName, studentLastName, studentRegno, department, gender, studentAddress,studentSection, studentEmail, studentMbno, dd, mm, yy);
		}
